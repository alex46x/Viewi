...
export default function SignupPage() {
  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        "fixed top-[-10%] right-[-10%] w-[500px] h-[500px] rounded-full blur-[120px] pointer-events-none -z-10 transition-colors duration-500",
        theme === 'dark' ? "bg-violet-600/15" : "bg-amber-200/20 animate-pulse"
      )} />
      <div className={cn(
        "fixed bottom-[-10%] left-[-10%] w-[500px] h-[500px] rounded-full blur-[120px] pointer-events-none -z-10 transition-colors duration-500",
      ...
      <AuthCard initialMode="signup" theme={theme} />
